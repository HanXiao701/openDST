                        ...
                        } :
                        {
                            ...
                            },
                            {
                                ...
                                listItem: [i18next.t('study_introduction_3.text1'), i18next.t('study_introduction_3.text1_1'),
                                    ...
                                    div > { i18next.t('study_introduction_3.text5a') } <
                                    Button variant = "contained"
                                    color = "secondary" > { i18next.t('button.cancel') } < /Button> { i18next.t('study_introduction_3.text5b') } <
                                    /div>]
                                }
                            ]
                        ...
                        render() {
                            ...
                            for (let i = 0; i < this.contentList[this.state.infoCounter].listItem.length; ++i) {
                                arrayOfListElements.push( <
                                    li className = "pb-1"
                                    key = { i } > { this.contentList[this.state.infoCounter].listItem[i] } < /li>
                                )
                            }
                            return < >
                                <
                                Slide direction = "right" in = { this.props.activeSlide === 'intro' }
                            mountOnEnter unmountOnExit >
                                ...
                                <
                                h3 className = "index-body-header px-3 py-2" > { this.contentList[this.state.infoCounter].header } <
                                /h3> <
                                /div> <
                                /div> <
                                CardContent className = "py-0" >
                                <
                                ul className = "list-styled ul stepper-bullet-point " > { arrayOfListElements } <
                                /ul> {
                                    this.state.infoCounter === 3 &&
                                        ...
                                        p > {
                                            ...
                                            href = { process.env.REACT_APP_ADDITIONAL_INFORMATION_URL_DE } > { i18next.t('study_introduction_3.additional_info') } < /a> :
                                                < a className = "additionalInfo"
                                            href = { process.env.REACT_APP_ADDITIONAL_INFORMATION_URL_EN } > { i18next.t('study_introduction_3.additional_info') } < /a>
                                        } <
                                        /p>
                                } <
                                /CardContent> <
                            ...
                            onClick = {
                                ...
                                /div> <
                                /Slide> <
                                Slide direction = "right" in = { this.props.activeSlide === 'consent' }
                            mountOnEnter unmountOnExit >
                                <
                                div >
                                <
                                ...
                                <
                                h3 className = "index-body-header py-2" > { this.contentList[this.state.infoCounter].header } <
                                /h3> <
                                /div> <
                                /div> <
                                CardContent className = "py-0" >
                            ...
                            label = { < div > { i18next.t('study_introduction_3_5.consensus_3a') } {
                                    this.props.language === 'de' ?
                                        < a className = "additionalInfo"
                                    href = { process.env.REACT_APP_ADDITIONAL_INFORMATION_URL_DE } > { i18next.t('study_introduction_3_5.consensus_3b') } < /a>: < a className = "additionalInfo"
                                    href = { process.env.REACT_APP_ADDITIONAL_INFORMATION_URL_EN } > { i18next.t('study_introduction_3_5.consensus_3b') } < /a>
                                ...
                                label = { < b > { i18next.t('study_introduction_3_5.consensus_2') } < /b>} /
                                    ...
                                    /div> <
                                    /Slide> <
                                    Slide direction = "right" in = { this.props.activeSlide === 'vas' }
                                    mountOnEnter unmountOnExit >
                                    <
                                    VisualAnalogueScale
                                    ...
                                    /> <
                                    /Slide> <
                                    Slide direction = "right" in = { this.props.activeSlide === 'panas' }
                                    mountOnEnter unmountOnExit >
                                    <
                                    Panas
                                    studyPage = 'baseline'
                                    ...
                                    /> <
                                    /Slide> <
                                    Slide direction = "right" in = { this.props.activeSlide === 'calibration' }
                                    mountOnEnter unmountOnExit >
                                    <
                                    Calibration
                                    handleNext = { this.props.handleNext }
